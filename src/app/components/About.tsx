      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-start">
        <div>
          ...
          <p className="text-tertiary leading-relaxed mb-8">
            ...
            with over 15 years of experience building and scaling enterprise
          ...
          <p className="text-tertiary leading-relaxed mb-8">
            A certified Oracle Java Master since 2011, Segun also holds a BTech
            in Information Technology and multiple technical certifications. His
            expertise spans high-performance systems, cloud-native architecture,
          ...
          <p className="text-tertiary leading-relaxed mb-8">
            ...
            Rather than simply leading from the top, he&apos;s built an
            ecosystem that empowers aspiring African tech talents through
          ...
          <p className="text-tertiary leading-relaxed">
            He&apos;s not just developing engineers — he&apos;s fostering a
            culture of excellence, inclusion, and impact. Through his
            leadership, a new generation of African tech professionals is rising
            — bold, equipped, and ready to lead.
          </p>
        </div>
